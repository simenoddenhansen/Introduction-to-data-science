I apologize for that oversight. It looks like the variables were stripped out in the previous formatting pass. Here is the clean, corrected Markdown file with all mathematical variables (, , , , and ) restored and properly formatted.
...
Would you like me to generate a script to plot these probabilities so you can visualize the results?
